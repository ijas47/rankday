        ...
        <div className="container">
          <div className="r-hero">
            ...
            <div className="hero-visual">
              ...
              <div className="float-badge hv-loc" style={{ top: "8%", right: -10 }}><div style={{ display: "flex", alignItems: "center", gap: 10 }}><div style={{ width: 38, height: 38, borderRadius: 8, background: "linear-gradient(135deg, #d8c4ff, #e8d4f0)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--purple)" }}><Icon.MapPin /></div><div><div style={{ fontSize: 11, color: "var(--muted)", fontWeight: 500 }}>Dubai · UAE</div><div style={{ fontSize: 14, color: "var(--ink)", fontWeight: 700, letterSpacing: "-0.01em" }}>Ranked #1</div></div></div></div>
