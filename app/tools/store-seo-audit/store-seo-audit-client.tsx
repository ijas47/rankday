...
import type { StoreAuditFinding, StoreAuditReport, StoreAuditSection } from "@/lib/store-seo-audit";
                ...
                {lockedCount > 0 && !unlocked ? (
                  <div className="card card-pink" style={{ padding: 24, marginTop: 18 }}>
                    ...
                    <p style={{ color: "var(--ink-2)", fontSize: 14, margin: "8px 0 0" }}>
                      Send it to your inbox. Agencies can use it before a discovery call.
                    </p>
