...
const serviceLd = serviceSchema({
  name: "SEO for Contractors",
  description: "A new website, top-3 Google rankings, and AI citations for contractors and construction companies. Residential and commercial. One fixed price. 90-day guarantee.",
  path: "/seo-for-contractors",
